      ...
      <div className="flex justify-between">
        <div className="flex gap-6 text-sm">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-primary-600 font-semibold">{jobTitle}</p>
            {startMonth && (
      ...
      <div className="text-[.8rem] ml-10">
        ...
        {description && (
          <span
            ...
            className="font-medium text-primary-600 hover:text-primary-700 cursor-pointer transition-colors duration-200"
          >
