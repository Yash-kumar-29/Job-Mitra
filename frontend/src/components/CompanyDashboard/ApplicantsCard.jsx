      ...
      <div className="flex flex-col md:flex-row gap-3.5 justify-end">
        {isShortlisted ? (
          <>
            ...
            <button className="p-2 px-4 font-medium text-xs rounded-md bg-primary-600 text-white hover:bg-primary-700 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center">
              💬 Request to chat
            </button>
          </>
        ) : (
