...
function Navbar() {
  ...
  const activeStyle = "text-primary-600 pb-4 border-b-2 border-primary-600 font-semibold";
        ...
        >
          ...
          {!status ? (
            <div className=" lg:flex ">
              <Link to="/login">
                <button className="border-2 border-primary-500 text-primary-600 font-bold py-1.5 px-5 rounded-md lg:ml-32 lg:ml-7 lg:shadow xl:ml-36 hover:bg-primary-500 hover:text-white transition-all duration-300 mr-5 lg:hover:scale-105">
                  Login
                </button>
              </Link>
              <Link to="/signup">
                <button className="bg-primary-600 text-white font-bold py-1.5 px-5 rounded-md lg:ml hover:bg-primary-700 transition-all duration-300 lg:hover:scale-105 lg:shadow">
                  Sign Up
                </button>
              </Link>
            </div>
            ...
            <>
              <div className="px-20 flex gap-8 items-center justify-center">
                <div>
                  <span>
                    <i className="fa-solid fa-bell text-xl text-gray-700 hover:text-primary-600 transition-colors duration-200"></i>
                  </span>
                </div>
                  ...
                  {isOpen && (
                    <div className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                      ...
                      >
                        ...
                        <p
                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 hover:cursor-pointer transition-colors duration-200"
                          role="menuitem"
                          onClick={() => {
                            handleLogout();
                            toggleDropdown();
