    ...
    <div className="mt-[3.8rem]  bg-[#ebeff5] flex flex-col items-center ">
      ...
      <form className="w-11/12 md:w-5/6 lg:w-4/6" onSubmit={handleSubmission}>
        <div className="bg-white  rounded-xl p-6 md:p-10 flex flex-col gap-6 mb-10">
          ...
          <div>
            <p className="font-medium">
              <span className="text-red-500 mr-1">*</span>What best describes
              your current role?
            </p>
          ...
          <div>
            <p className="font-medium">
              <span className="text-red-500 mr-1">*</span>How many years of
          ...
          <div>
            <p className="font-medium">
              <span className="text-red-500 mr-1">*</span>Where do you
              currently work?
            </p>
            <div className="pl-3 flex flex-col gap-2">
          ...
          <button
            type="submit"
            className="flex justify-center items-center bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-3xl w-48 py-2 px-3.5 transition-all duration-300 shadow-md hover:shadow-lg"
          >
            Create your profile
          </button>
        </div>
