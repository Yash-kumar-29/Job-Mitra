    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="sm:w-3/6 sm:h-screen flex items-center justify-center sm:pt-5 sm:pl-5 md:w-3/5 lg:pl-16 lg:pt-5">
          <div className="h-full w-full sm:text-right sm:pr-12 bg-gradient-to-br from-primary-600 to-primary-800 sm:pt-24 sm:pl-14 text-white sm:rounded-t-lg lg:pt-44">
            ...
            <p className="hidden sm:block font-light sm:pl-3 sm:text-lg text-primary-50 xl:text-xl xl:pl-16">
              {userType === "jobSeeker"
        ...
        <div className="w-full sm:w-3/6 pt-1.5 md:w-2/5">
          <div className="flex flex-col md:flex-row justify-center items-center gap-5 ">
            <div
              ...
              className={`rounded-md px-5 py-1 cursor-pointer font-semibold transition-all duration-300 ${
                userType === "jobSeeker" ? "bg-primary-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
            >
              I am a Job Seeker
            </div>
            <div
              ...
              className={`rounded-md px-5 py-1 cursor-pointer font-semibold transition-all duration-300 ${
                userType === "employer" ? "bg-primary-600 text-white shadow-md" : "bg-gray-100 text-gray-600 hover:bg-gray-200"
              }`}
            >
              I am an Employer
            </div>
          ...
          <div className="p-3 sm:p-10 ">
            ...
            <form className="mt-3" onSubmit={handleFormSubmission}>
              <div className="flex flex-col">
                ...
                <button
                  type="submit"
                  className="bg-primary-600 hover:bg-primary-700 rounded-md text-white font-semibold text-sm h-11 mt-3 transition-all duration-300 shadow-md hover:shadow-lg"
                >
