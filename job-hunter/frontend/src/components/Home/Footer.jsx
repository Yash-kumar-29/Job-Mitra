    ...
    <div className="md:flex justify-between py-12 border-t border-gray-300  ">
      <div className="md:w-2/5 ml-6 md:ml-20 flex flex-col gap-2 py-4 md:py-0">
        ...
        <div className=" flex gap-3 text-2xl ml-3.5 text-gray-800">
          <i className="fa-brands fa-twitter cursor-pointer hover:text-primary-600 transition-colors duration-200"></i>
          <i className="fa-brands fa-instagram cursor-pointer hover:text-primary-600 transition-colors duration-200"></i>
          <i className="fa-brands fa-linkedin-in cursor-pointer hover:text-primary-600 transition-colors duration-200"></i>
        </div>
      </div>
      <div className="md:flex justify-between md:w-3/5 px-10 md:px-0">
        <div className="flex flex-col gap-2.5 py-5 md:py-0">
          ...
          <p className=" cursor-pointer text-lg md:text-base hover:underline hover:text-primary-600 transition-colors duration-200">
            Overview
          </p>
          <p className=" cursor-pointer text-lg md:text-base hover:underline hover:text-primary-600 transition-colors duration-200">
            Startup Jobs
