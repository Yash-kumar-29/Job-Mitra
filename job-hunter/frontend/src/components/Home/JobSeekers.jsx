  ...
  return (
    <div className="md:flex px-5 md:px-10 py-20 md:py-32 font-Poppins">
      ...
      <div className="md:w-1/2 px-5 md:px-16">
        ...
        <div className="my-10">
          <Link to="/login">
            <button className="border-2 border-primary-500 text-primary-600 font-medium py-2 px-5 rounded-xl md:shadow hover:bg-primary-500 hover:text-white transition-all duration-300 mr-5 md:hover:scale-105">
              Learn more
            </button>
          </Link>
          <Link to="/signup">
            <button className="bg-primary-600 text-white font-medium py-2 px-5 rounded-xl hover:bg-primary-700 transition-all duration-300 md:hover:scale-105 md:shadow">
              Sign up now
            </button>
          </Link>
        </div>
